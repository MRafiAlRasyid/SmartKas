              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-header-action">
                    <a href="{{ route('admin.pemasukan.create') }}" class="btn btn-primary">Tambah <i class="fas fa-plus"></i></a>
                  </div>
                </div>
                    ...
                    <table class="table table-bordered mb-0 text-center">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $pemasukan->perincian }}</td>
                          <td>{{ number_format($pemasukan->pemasukan) }}</td>
                          <td>
                            <a href="{{ route('admin.pemasukan.edit', $pemasukan->id) }}" class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                            <button class="btn btn-danger btn-action" data-toggle="tooltip" title="Delete" onclick="handleDelete({{ $pemasukan->id }})"><i class="fas fa-trash"></i></button>
                            <form action="{{ route('admin.pemasukan.delete', $pemasukan->id) }}" method="POST"
                              id="form-delete-{{ $pemasukan->id }}">
                              @csrf
                              @method('DELETE')
                            </form>
                          </td>
