          ...
          <div class="row">
            <div class="col-lg-6 col-md-12 col-12 col-sm-12">
              <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form action="{{ route('admin.pemasukan.update', $pemasukans->id) }}" method="post">
                      @csrf
                      @method('PUT')
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Jumlah</label>
                            <input type="number" class="form-control" id="exampleFormControlInput1" name="pemasukan" value="{{ $pemasukans->pemasukan }}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Tanggal</label>
                            <input type="date" class="form-control" id="exampleFormControlInput1" name="tanggal" value="{{ $pemasukans->tanggal }}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Perincian</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="perincian">{{ $pemasukans->perincian }}</textarea>
                        </div>
