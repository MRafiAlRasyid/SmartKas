              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-header-action">
                    <a href="{{ route('admin.pengeluaran.create') }}" class="btn btn-primary">Tambah <i class="fas fa-plus"></i></a>
                  </div>
                </div>
                    ...
                    <table class="table table-bordered mb-0 text-center">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $pengeluaran->perincian }}</td>
                          <td>{{ number_format($pengeluaran->pengeluaran) }}</td>
                          <td>
                            <a href="{{ route('admin.pengeluaran.edit', $pengeluaran->id) }}" class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                            <button class="btn btn-danger btn-action" data-toggle="tooltip" title="Delete" onclick="handleDelete({{ $pengeluaran->id }})"><i class="fas fa-trash"></i></button>
                            <form action="{{ route('admin.pengeluaran.delete', $pengeluaran->id) }}" method="POST"
                              id="form-delete-{{ $pengeluaran->id }}">
                              @csrf
                              @method('DELETE')
                            </form>
                          </td>
