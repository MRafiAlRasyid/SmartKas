      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a class="nav-link" href="{{ route('admin.pengeluaran.create') }}"><i class="fas fa-plus"></i><span>pengeluaran</span></a>
            </li>
            <li>
            ...
            <li class="active">
              <a href="{{ route('admin.pengeluaran.index') }}" class="nav-link"><i class="fas fa-arrow-right"></i><span>pengeluaran</span></a>
            </li>
            <li>
          ...
          <div class="row">
            <div class="col-lg-6 col-md-12 col-12 col-sm-12">
              <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form action="{{ route('admin.pengeluaran.update', $pengeluarans->id) }}" method="post">
                      @csrf
                      @method('PUT')
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Jumlah</label>
                            <input type="number" class="form-control" id="exampleFormControlInput1" name="pengeluaran" value="{{ $pengeluarans->pengeluaran }}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Tanggal</label>
                            <input type="date" class="form-control" id="exampleFormControlInput1" name="tanggal" value="{{ $pengeluarans->tanggal }}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Perincian</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="perincian">{{ $pengeluarans->perincian }}</textarea>
                        </div>
